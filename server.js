...
app.get('/api/health', (_req, res) => res.json({ success: true, message: 'Thiên Cơ vận chuyển ổn định.' }));
...
async function bootstrap() {
  ...
  const server = app.listen(PORT, () => console.log(`[THIEN_CO] http://localhost:${PORT}`));
